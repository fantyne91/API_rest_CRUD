...
const connectDB = async () => {
  ...
  try {
    /* usamos await porque el proceso de conectarse será asíncrono y utilizamos el
        método connect de mongoose al cual le aportamos la url de la BBDD que la cogemos desde el .env*/
